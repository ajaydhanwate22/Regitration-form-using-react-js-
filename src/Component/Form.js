    ...
    return (
        <div className="max-w-md mx-auto p-4 bg-gray-100 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit"
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Submit
                    </button>
            </form>
            {submittedData && (
